      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <a href="https://delivery-app-481756503401.us-east1.run.app" aria-label="Delivery View" style={{ padding: '0.5rem', color: weekInfo.text, opacity: 0.7 }}>
